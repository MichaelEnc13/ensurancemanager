<?php
    ...
    elseif (isset($_GET['editCar'])) :
        $carInfo = Client::see_client_cars($_GET['cid'], $_GET['car_plate'])['data']->fetch();
    endif;
    ...
    <form id="form" class="form form_new_register" onsubmit="return false">
        ...
        <?php if (!isset($_GET['newcar']) && !isset($_GET['editCar'])) : ?>
            ...
            <div class="form__control">
                <input type="text" class="form__input" name="fname" value="<?php echo $fname ?>" placeholder="Nombre(s)">
                <input type="text" class="form__input" name="lname" value="<?php echo $lname ?>" placeholder="Apellido(s)">
            </div>
            <div class="form__control">
                <input type="text" class="form__input" name="cid"   value="<?php echo $cid ?>" placeholder="Cedula de identidad">
                <input type="text" class="form__input" name="address" value="<?php echo $address ?>" placeholder="Dirección">
            </div>
            <div class="form__control">
                <input type="tel" class="form__input" name="tel" value="<?php echo $tel ?>" placeholder="Telefono">
                <input type="email" class="form__input" name="email" value="<?php echo $email ?>" placeholder="Correo electronico">
            </div>
