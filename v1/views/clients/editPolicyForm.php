    ...
    <div class="form__control form__control--aditionalService">
        <div class="form__control__aditionalService__checkbox">
            <div class="form__control__checkbox__control">
                <input type="checkbox" data-value="540" data-index="0" data-tel="809-565-8222" value="Patria asistencia" class="aditional_service " disabled>
            ...
            <div class="form__control__checkbox__control">
                <input type="checkbox" data-value="1500" data-index="2" data-tel="809-565-8222" value="Casa del conductor" class="aditional_service" disabled>
                <label>Casa del conductor (RD $ 1,500)</label>
            </div>


            <div class="form__control__checkbox__control">
                <input type="checkbox" data-value="1300" data-index="3" data-tel="809-565-8222" value="Centro del automovilista" class="aditional_service" disabled>
